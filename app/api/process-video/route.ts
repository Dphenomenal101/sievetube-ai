...
export const jobCache = new Map<string, {
...
async function updateJobStatus(videoId: string, status: 'downloading' | 'transcribing' | 'completed' | 'failed', error?: string) {
...
async function transcribeAudio(downloadJobId: string) {
  ...
  // Start transcription
  console.log('Making transcription request with payload:', JSON.stringify({
